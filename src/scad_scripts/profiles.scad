...
module KAT_keycap(
  ...
  width = 18.2,
  height_extra = 0,
  wall_thickness = 1.658,
  dish_thickness = 1.658,
  dish_fn = 128,
  dish_corner_fn = 64,
  dish_depth = 0.75,
  dish_invert = false,
...
module XDA_keycap(
  ...
  wall_thickness = 1.5,
  dish_thickness = 1.5,
  dish_fn = $preview ? 28 : 256,
  dish_corner_fn = $preview ? 16 : 64,
  dish_depth = 1,
  dish_invert = false,
  stem_clips = false,
  stem_walls_inset = 0,
  top_difference = 19.05 / 5,
  key_rotation = [0, 0, 0],
  corner_radius = 0.3,
